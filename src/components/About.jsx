    ...
    <>
      ...
      >
        Я опытный разработчик программного обеспечения с опытом работы с TypeScript и
         JavaScript, имею опыт работы с такими фреймворками, как React, Node.js и
         Three.js. Я быстро учусь и тесно сотрудничаю с клиентами, чтобы
         создавать эффективные, масштабируемые и удобные решения. 
